...
category_dict = {'Credit': u'销售部', 'Customer': u'销售部', 'Delorder': u'事务管理', 'Delorderinfo': u'事务管理', 'Employee': u'事务管理', 'Inventory': u'库存部', 'Lackorder': u'采购部', 'Orderinfo': u'销售部',  'Paybillaccount': u'财务部', 'Preorder': u'发货部', 'Preorderinfo': u'发货部', 'Product': u'库存部', 'Puraccount': u'财务部', 'Purorder': u'采购部', 'Reminder': u'事务管理', 'Reminderinfo': u'事务管理', 'Reorder': u'销售部', 'Sellaccount': u'财务部', 'Shoppingcart': 'Other', 'Supplier': u'采购部', 'Torder': u'销售部'}

name_dict = {'Credit': u'客户信用', 'Customer': u'客户信息', 'Delorder': u'已删除订单', 'Delorderinfo': u'已删除订单详情', 'Employee': u'员工信息', 'Inventory': u'库存信息', 'Lackorder': u'缺货单', 'Orderinfo': u'订单详情',  'Paybillaccount': u'付款账户', 'Preorder': u'备货单', 'Preorderinfo': u'备货单详情', 'Product': u'产品信息', 'Puraccount': u'采购账户', 'Purorder': u'采购订单', 'Reminder': u'删除提醒详情', 'Reminderinfo': u'删除提醒详情', 'Reorder': u'再订货订单', 'Sellaccount': u'销售账户', 'Shoppingcart': 'Other', 'Supplier': u'供货商信息', 'Torder': u'订单信息'}
...
roles_dict = {'Credit': ['1', '2'], 'Customer': ['1', '2'], 'Delorder': ['1'], 'Delorderinfo': ['1'], 'Employee': ['1'], 'Inventory': ['1', '5'], 'Lackorder': ['1', '4'], 'Orderinfo': ['1', '2'],  'Paybillaccount': ['1', '3'], 'Preorder': ['1', '6'], 'Preorderinfo': ['1', '6'], 'Product': ['1', '4', '5'], 'Puraccount': ['1', '3'], 'Purorder': ['1', '4'], 'Reminder': ['1'], 'Reminderinfo': ['1'], 'Reorder': ['1', '2'], 'Sellaccount': ['1', '3'], 'Shoppingcart': ['1'], 'Supplier': ['1', '4'], 'Torder': ['1', '2']}
